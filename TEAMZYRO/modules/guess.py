...
async def guess(client: Client, message: Message):
    ...
    if sorted(name_parts) == sorted(guess.split()) or any(part == guess for part in name_parts):
        ...
        await message.reply_text(
            f'🌟 <b><a href="tg://user?id={user_id}">{escape(message.from_user.first_name)}</a></b>, you\'ve captured a new cricketer! 🎊\n\n'
            ...
            f'This Cricketer has been added to Your Harem. Use /harem to see your harem.</b>',
        ...
        if message_id:
            ...
            await message.reply_text('❌ Not quite right, brave guesser! Try again! 🐥')
